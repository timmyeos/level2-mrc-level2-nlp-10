...
from dpr_train import DenseRetrieval,dense_args
# import torch
...
# arguments.py에서 retriever_type으로 원하는 retriever 변경 가능
def run_retrieval(
    ...
    elif retriever_args.retriever_type == 'Dense Passage Retriever' :
        args, tokenizer, p_enc, q_enc = dense_args(retriever_args)
